...
from app.services.socioeconomic_service import get_socioeconomic_data
...
def get_socioeconomic_map(city: str = Query(default="atlanta")):
    return get_socioeconomic_data(city)